...
<header>
  <nav class="navbar">
    ...
    <div class="nav-links" id="menu">
      <a href="mantener_cliente.php"><i class="fas fa-user"></i> Clientes</a>
      <a href="mantener_servicio.php"><i class="fas fa-concierge-bell"></i> Servicios</a>
      <a href="mantener_empleado.php"><i class="fas fa-user-tie"></i> Empleados</a>
      <a href="mantener_mascota.php"><i class="fa-solid fa-paw"></i> Mascotas</a>
        ...
        while ($fila = $resultado->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>
                        ...
                        <button class='btn-delete' onclick='confirmarEliminacion({$fila['id_veterinario']})'>
...
<div class="modal" id="modalConfirmacion">
    <div class="modal-content">
        <h2>¿Estás seguro que deseas eliminar este veterinario?</h2>
...
btnEliminar.addEventListener('click', function() {
    window.location.href = 'eliminar_veterinario.php?id=' + idVeterinario;
});
</script>
